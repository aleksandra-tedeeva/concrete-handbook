...
export default function PushingColumnEdge() {
  const isMobile = useIsMobile();
  return (
    <Box m={2}>
      <Stack px="24px" spacing={2}>
        <Typography variant="h5">
          Проверка несущей способности на продавливание (колонна на краю)
        </Typography>
      ...
      <Stack my="16px" spacing={1}>
        ...
        <Typography>
          ...
          расположена рядом с краем плоского элемента.
        </Typography>
        <Typography>
      ...
      <Stack my="16px">
        ...
        <Stack>
          <Box>
            <img
              alt="calc_pushing_col_edge"
              src="/assets/calc_pushing_col_edge.png"
