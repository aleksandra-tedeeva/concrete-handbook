  ...
  return (
    <TableContainer>
      <Table stickyHeader size="small">
        <TableHead>
          <TableRow>
            <TableCell className="highlight-cell--gray">Здания, стены и перегородки</TableCell>
            <TableCell className="highlight-cell--gray">
              Крепление стен и перегородок к каркасу здания
            </TableCell>
            <TableCell className="highlight-cell--gray">Предельные перемещения</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          <TableRow>
          ...
          <TableRow>
            <TableCell>
              б) стены, облицованные естественным камнем, из керамических блоков, из стекла
              (витражи)
            </TableCell>
