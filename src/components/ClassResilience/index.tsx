    ...
    <>
      <Box sx={{ padding: '0px 16px 16px 16px' }}>
        <Typography component="div">
          Значения начального модуля упругости бетона E<sub>b</sub> (МПА/1000) при сжатии и
          растяжении при классе бетона по прочности на сжатие
        </Typography>
      </Box>
      <TableContainer className="big-table-height-fix">
        <Table stickyHeader size="small">
          ...
          <TableBody>
            ...
            <TableRow>
              <TableCell sx={{ fontWeight: 500 }} className="sticky-cell highlight-cell--gray">
                Мелкозернистых групп
              </TableCell>
              {resilience.grain_natural.map((val, idx) => (
                <TableCell className="highlight-cell--gray" key={idx}></TableCell>
              ))}
            </TableRow>
            <TableRow>
              <TableCell className="sticky-cell">А - естественного твердения</TableCell>
              {resilience.grain_natural.map((val, idx) => (
                <TableCell key={idx}>{val}</TableCell>
              ))}
            </TableRow>
            <TableRow>
              <TableCell className="sticky-cell">Б - автоклавного твердения</TableCell>
      ...
      <Box sx={{ padding: '16px 0px' }}>
        <Typography component="div">
          1. Для мелкозернистого бетона группы А, подвергнутого тепловой обработке или при
          атмосферном давлении, значения начальных модулей упругости бетона следует принимать с
          коэффициентом 0,89
        </Typography>
        <Typography component="div">
          2. Для легкого, ячеистого и поризованного бетонов при промежуточных значениях плотности
          бетона начальные модули упругости принимают по линейной интерполяции
        </Typography>
        <Typography component="div">
          3. Для ячеистого бетона неавтоклавного твердения значения Еb принимают как для бетона
          автоклавного твердения с умножением на коэффициент 0,8
        </Typography>
        <Typography component="div">
          4. Для напрягающего бетона значения Еb принимают как для тяжелого бетона с умножением на
          коэффициент a = 0,56 + 0,006В
        </Typography>
      </Box>
    </>
  );
