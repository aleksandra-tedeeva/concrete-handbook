    ...
    <TableContainer>
      <Table stickyHeader size="small">
        ...
        <TableBody>
          <TableRow>
            <TableCell>
              1. Балки крановых путей под мостовые и подвесные краны,
              управляемые:
            </TableCell>
            <TableCell>&nbsp;</TableCell>
            <TableCell>&nbsp;</TableCell>
          ...
          <TableRow>
            ...
            <TableCell>
              Приводящие к уменьшению зазора между несущими элементами
              конструкций и перегородками, расположенными под элементами
            </TableCell>
          </TableRow>
          <TableRow>
            <TableCell>
              в) покрытий и перекрытий при наличии на них элементов,
              подверженных растрескиванию (стяжек, полов, перегородок)
            </TableCell>
          ...
          <TableRow>
            ...
            <TableCell>
              Временные с учетом нагрузки от одного крана или тельфера (тали) на
              одном пути
            </TableCell>
          </TableRow>
          <TableRow>
          ...
          <TableRow>
            <TableCell>
              д) перекрытий, подверженных действию: перемещаемых грузов,
              материалов, узлов и элементов оборудования и других подвижных
              нагрузок (в том числе при безрельсовом напольном транспорте)
            </TableCell>
            <TableCell>Физиологические и технологические</TableCell>
            <TableCell>l/350</TableCell>
            <TableCell>
              0,7 полных нормативных значений временных нагрузок или нагрузки от
              одного погрузчика (более неблагоприятное из двух)
            </TableCell>
          </TableRow>
          <TableRow>
          ...
          <TableRow>
            ...
            <TableCell>l/400</TableCell>
            <TableCell rowSpan={2}>
              От одного состава вагонов (или одной напольной машины) на одном
              пути
            </TableCell>
          </TableRow>
          <TableRow>
          ...
          <TableRow>
            ...
            <TableCell>Физиологические</TableCell>
            <TableCell colSpan={2}>
              Определяются в соответствии в с.п. Е.2.2
            </TableCell>
          </TableRow>
          <TableRow>
            <TableCell>
              4. Плиты перекрытий, лестничные марши и площадки, прогибу которых
              не препятствуют смежные элементы
            </TableCell>
            <TableCell>&#171;</TableCell>
          ...
          <TableRow>
            <TableCell>
              5. Перемычки и навесные стеновые панели над оконными и дверными
              проемами (ригели и прогоны остекления)
            </TableCell>
            <TableCell>Конструктивные</TableCell>
            <TableCell>l/200</TableCell>
            <TableCell>
              Приводящие к уменьшению зазора между несущими элементами и оконным
              или дверным заполнением, расположенным под элементами
            </TableCell>
          </TableRow>
          <TableRow>
            <TableCell>&nbsp;</TableCell>
