        ...
        <Table size="small">
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell>
                {data.corresponding_class ? (
                  <Button
                    disabled={
                      !availableClasses.includes(data.corresponding_class)
                    }
                    sx={{ marginLeft: "-16px" }}
                    onClick={() =>
                      showFullResult("class", data.corresponding_class)
                    }
                  >
                    {data.corresponding_class}
                  </Button>
            ...
            <TableRow>
              ...
              <TableCell>
                {data.second_group.compression.aerated || "-"}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Ячеистый вида А</TableCell>
              <TableCell>
                {data.second_group.compression.cellular_a || "-"}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Ячеистый вида Б</TableCell>
              <TableCell>
                {data.second_group.compression.cellular_b || "-"}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell
            ...
            <TableRow>
              ...
              <TableCell>
                {data.second_group.expansion.aerated_dense || "-"}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>
              ...
              <TableCell>
                {data.second_group.expansion.aerated_porous || "-"}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Ячеистый вида А</TableCell>
              <TableCell>
                {data.second_group.expansion.cellular_a || "-"}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Ячеистый вида Б</TableCell>
              <TableCell>
                {data.second_group.expansion.cellular_b || "-"}
              </TableCell>
            </TableRow>
            ...
            <TableRow>
              <TableCell>На пористых заполнителях</TableCell>
              <TableCell>
                {data.first_group.compression.aerated || "-"}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Ячеистый вида А</TableCell>
              <TableCell>
                {data.first_group.compression.cellular_a || "-"}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Ячеистый вида Б</TableCell>
              <TableCell>
                {data.first_group.compression.cellular_b || "-"}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Крупнопористый</TableCell>
              <TableCell>
                {data.first_group.compression.large_porous || "-"}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell
            ...
            <TableRow>
              ...
              <TableCell>
                {data.first_group.expansion.aerated_dense || "-"}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>
              ...
              <TableCell>
                {data.first_group.expansion.aerated_porous || "-"}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Ячеистый вида А</TableCell>
              <TableCell>
                {data.first_group.expansion.cellular_a || "-"}
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Ячеистый вида Б</TableCell>
              <TableCell>
                {data.first_group.expansion.cellular_b || "-"}
              </TableCell>
            </TableRow>
          </TableBody>
        </Table>
